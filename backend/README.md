...
## Project Structure
    ...
    ├── api_deploy_test_app_50795  # Django project configurations
...
1. Clone this repo and `cd api_deploy_test_app_50795`
...
2. Clone this repo and `cd api_deploy_test_app_50795`

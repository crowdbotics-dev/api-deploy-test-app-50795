"""
Django settings for api_deploy_test_app_50795 project.
...
ROOT_URLCONF = 'api_deploy_test_app_50795.urls'
...
WSGI_APPLICATION = 'api_deploy_test_app_50795.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "api_deploy_test_app_50795 API",
    "DESCRIPTION": "API documentation for api_deploy_test_app_50795 App",
    "VERSION": "v1",
}
